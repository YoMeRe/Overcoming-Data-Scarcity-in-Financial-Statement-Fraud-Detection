...
from data_pipeline.data_preparation import DataPrep
# Model class for the CTABGANSynthesizer
from data_synthesizer.ctabgan_synthesizer import CTABGANSynthesizer 
...
class CTABGAN():
    ...
    def __init__(self,
        ...
        self.synthesizer = CTABGANSynthesizer(class_dim=class_dim, random_dim=random_dim, num_channels=num_channels, batch_size=batch_size, epochs = epochs)
