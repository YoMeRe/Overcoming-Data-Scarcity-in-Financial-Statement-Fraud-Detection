...
from synthesizer.fctgan_synthesizer import FCTGANSynthesizer
...
class FCTGAN():
    ...
    def __init__(self,
        ...
        self.synthesizer = FCTGANSynthesizer(class_dim=class_dim,random_dim=random_dim,num_channels=num_channels,batch_size=batch_size,epochs=epochs)
